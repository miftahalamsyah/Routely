...
<section class="mt-20 max-w-6xl justify-center mx-auto px-5">
    ...
    <div class="flex flex-row justify-center items-center grid-cols-1 font-semibold">
        <span class="bg-stone-50 w-full h-14 max-w-2xl text-gray-900 flex items-center justify-center mr-3 rounded-xl border border-gray-700 border-4 hover:underline mb-4">
        ...
        <span class="bg-stone-50 w-full h-14 max-w-2xl text-gray-900 flex items-center justify-center ml-3 rounded-xl border border-blue-500 border-4 hover:underline mb-4">
