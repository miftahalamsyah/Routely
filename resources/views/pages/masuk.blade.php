...
<section class="my-24 mx-auto justify-center items-center max-w-lg">
    <main class="flex justify-center px-8 py-8 sm:px-12 bg-stone-50 mx-2 border border-r-4 border-b-4 border-stone-700">
        <div class="py-4">
            <svg class="mx-auto w-10 h-10 mb-5 text-violet-500" fill="currentColor" viewBox="0 0 512 512"><path d="M512 96c0 50.2-59.1 125.1-84.6 155c-3.8 4.4-9.4 6.1-14.5 5H320c-17.7 0-32 14.3-32 32s14.3 32 32 32h96c53 0 96 43 96 96s-43 96-96 96H139.6c8.7-9.9 19.3-22.6 30-36.8c6.3-8.4 12.8-17.6 19-27.2H416c17.7 0 32-14.3 32-32s-14.3-32-32-32H320c-53 0-96-43-96-96s43-96 96-96h39.8c-21-31.5-39.8-67.7-39.8-96c0-53 43-96 96-96s96 43 96 96zM117.1 489.1c-3.8 4.3-7.2 8.1-10.1 11.3l-1.8 2-.2-.2c-6 4.6-14.6 4-20-1.8C59.8 473 0 402.5 0 352c0-53 43-96 96-96s96 43 96 96c0 30-21.1 67-43.5 97.9c-10.7 14.7-21.7 28-30.8 38.5l-.6 .7zM128 352a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zM416 128a32 32 0 1 0 0-64 32 32 0 1 0 0 64z"/></svg><span class="clashdisplaymedium text-center my-2 text-md text-orange-500 sm:text-md md:text-md text-center">Demo</span>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="col-span-6">
                    ...
                    <input type="email" id="input-email" name="email" class="border border-stone-700 my-2 p-2 rounded-lg w-full" required value="miftahrizkyalamsyah@protonmail.com">
                    @error('email')
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="password" id="input-password" name="password" class="border border-stone-700 my-2 p-2 rounded-lg w-full" required value="miftahrizkyalamsyah@protonmail.com">
                    @error('password')
                        <div class="text-red-500">{{ $message }}</div>
                    @enderror
                </div>
