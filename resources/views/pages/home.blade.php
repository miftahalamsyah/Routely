...
<section class="max-w-6xl justify-center mx-auto">
    <div class="px-10 py-40 mx-auto animate-up">
        <div class="w-full mx-auto text-center">
            <h1 class="mb-6 text-4xl font-semibold leading-none max-w-3xl mx-auto tracking-normal text-stone-900 sm:text-4xl md:text-5xl lg:text-5xl xl:text-5xl md:tracking-tight">Gunakan<span class="w-full text-transparent bg-clip-text bg-gradient-to-r from-violet-700 via-purple-500 to-violet-300 lg:inline"> Routely </span>untuk pengalaman belajar yang baru*</h1>
    ...
    <div class="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        <div class="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
            <div class="mx-auto max-w-lg text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
                <h2 class="text-stone-800 text-3xl font-bold sm:text-3xl md:text-4xl lg:text-4xl">Berfokus pada Berpikir Komputasi</h2>
...
<section class="mb-20">
    <div class="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        <div class="mx-auto max-w-3xl text-left lg:mx-0 my-4">
            <h2 class="text-stone-800 text-3xl font-bold sm:text-3xl md:text-4xl lg:text-4xl">Dengan Menerapkan Problem Posing</h2>
            <p class="mt-4 text-stone-700">
        ...
        <div class="grid grid-cols-2 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
            <a class="block rounded-xl bg-stone-50 p-4 shadow hover:shadow-lg" href="/problem-posing">
                <span class="inline-block rounded-lg bg-stone-50">
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 14l9-5-9-5-9 5 9 5z"></path>
                        <path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"></path>
