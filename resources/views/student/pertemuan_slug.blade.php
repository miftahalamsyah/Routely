...
<section class="w-full justify-center mx-auto px-4 lg:px-12 min-h-screen">
    <div class="rounded-xl">
        ...
        <div class="row py-5 text-stone-700">
            ...
            {{-- 1 persiapan --}}
            <div x-data="{ persiapan: true}" class="w-full mx-auto bg-stone-50 p-5 rounded-2xl shadow-md my-4">
            ...
            {{-- 2 pemahaman --}}
            <div x-data="{ pemahaman: true}" class="w-full mx-auto bg-stone-50 p-5 rounded-2xl shadow-md my-4">
            ...
            {{-- 3 Situasi Masalah --}}
            <div x-data="{ situasiMasalah: true}" class="w-full mx-auto bg-stone-50 p-5 rounded-2xl shadow-md my-4">
            ...
            {{-- 4 Pengajuan Masalah --}}
            <div x-data="{ pengajuanMasalah: true}" class="w-full mx-auto bg-stone-50 p-5 rounded-2xl shadow-md my-4">
                ...
                <div x-show="pengajuanMasalah" class="relative flex flex-col break-words">
                    <div class="flex-auto p-4 my-2 bg-stone-100 border-2 rounded-2xl">
                        <p class="text-md font-semibold">Membuat Topologi</p>
            ...
            {{-- 5 Pemecahan Masalah --}}
            <div x-data="{ pemecahanMasalah: true}" class="w-full mx-auto bg-stone-50 p-5 rounded-2xl shadow-md my-4">
            ...
            {{-- 6 Verifikasi --}}
            <div x-data="{ verifikasi: true}" class="w-full mx-auto bg-stone-50 p-5 rounded-2xl shadow-md my-4">
