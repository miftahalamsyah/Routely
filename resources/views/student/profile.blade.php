        ...
        <div class="px-2">
            <form action="{{ route('student.profile.update') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" value="{{ Auth::user()->name }}" class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline-blue focus:border-blue-300 dark:bg-gray-800 dark:text-gray-100 dark:border-gray-700">
                </div>
                <div class="mb-4">
                    <label for="email" class="block mb-2 font-semibold text-sm text-gray-700 dark:text-gray-400">Email</label>
                    <input type="email" name="email" id="email" value="{{ Auth::user()->email }}" class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline-blue focus:border-blue-300 dark:bg-gray-800 dark:text-gray-100 dark:border-gray-700">
                </div>
                <div class="mb-4">
                    <label for="password" class="block mb-2 font-semibold text-sm text-gray-700 dark:text-gray-400">Password</label>
                    <input type="password" name="password" id="password" class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline-blue focus:border-blue-300 dark:bg-gray-800 dark:text-gray-100 dark:border-gray-700">
                </div>
                <div class="mb-4">
