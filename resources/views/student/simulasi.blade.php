...
<section class="mt-12 max-w-6xl justify-center mx-auto px-5">
    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <a href="/student" class="inline-flex items-center text-sm font-medium text-stone-700 hover:text-violet-800">
    ...
    <h2 class="mb-4 text-2xl font-extrabold tracking-tight leading-none text-violet-900 md:text-3xl">Simulasi</h2>
    <!-- Content -->
