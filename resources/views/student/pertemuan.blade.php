    ...
    @forelse ($pertemuans as $pertemuan)
        ...
        <div class="relative flex flex-col break-words bg-stone-50 border shadow-lg rounded-2xl my-2">
            <div class="flex-auto px-1 pt-6">
                <p class="px-2 leading-normal text-xl text-student font-bold overflow-hidden ...">Pertemuan {{ $pertemuan->pertemuan_ke }}</p>
                <p class="px-2 leading-normal text-xs text-stone-400 overflow-hidden">
                    {{ Carbon\Carbon::parse($pertemuan->tanggal)->format('l, j F Y') }}
                </p>
                <div class="relative flex flex-col min-w-0 break-words bg-stone-100 mx-2 border rounded-2xl my-4">
