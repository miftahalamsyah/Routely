...
<section class="w-full justify-center min-h-screen mx-auto mt-2 px-2 lg:px-12">
    <div id="leaderboardSection" class="bg-stone-50 overflow-y-auto mb-2 p-2 rounded-md border border-r-4 border-b-4 border-stone-700  shadow-md">
        <div class="py-12 px-4 mx-auto text-center z-20">
            <h1 class="clashdisplaymedium mb-4 text-3xl tracking-tight leading-none text-stone-700 md:text-4xl lg:text-4xl"><span class="w-full text-transparent bg-clip-text bg-gradient-to-r from-violet-700 via-purple-500 to-violet-300 lg:inline"> Routely </span>League</h1>
