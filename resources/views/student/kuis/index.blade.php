                ...
                <div class="border-0">
                    <form method="POST" action="{{ route('hasil_kuis_siswa.store') }}">
                        ...
                        <div class="flex justify-between">
                            <p></p>
                            <button type="submit" id="submitBtn" class="bg-student py-2 px-5 font-semibold text-gray-50 rounded-full hover:bg-student-dark shadow-md">Selesaikan Kuis</button>
                        </div>
