...
<html lang="en">
    ...
    <body class="text-stone-700">
        ...
        <main id="main-content" class="justify-center ml-0 sm:ml-0 md:ml-28 lg:ml-24 pt-5 transition-margin ease-in-out duration-300">
                        ...
                        <div class="flex flex-row items-center justify-end gap-2">
                            ...
                            <div x-data="{ open: false }" class="md:order-2 z-10 dropdown inline-block relative rounded-2xl hover:shadow-lg" title="Akun Saya">
                                @auth
                                    ...
                                    <ul x-show="open"@click.away="open = false" class="dropdown-menu absolute mr-40 bg-stone-50 rounded-sm hidden text-stone-700 w-40 right-0 transform translate-x-full">
                                        <li class="text-xs rounded-sm border border-r-4 border-b-4 border-stone-700 shadow-md">
                                            <a href="/student" class="text-stone-700 block px-4 py-2 text-sm hover:bg-stone-100 hover:underline" role="menuitem" tabindex="-1" id="menu-item-0">Dashboard</a>
                                            <a href="/student/profile" class="text-stone-700 block px-4 py-2 text-sm hover:bg-stone-100 hover:underline" role="menuitem" tabindex="-1" id="menu-item-0">Profil</a>
                                            <a href="/bantuan" class="text-stone-700 block px-4 py-2 text-sm hover:bg-stone-100 hover:underline" role="menuitem" tabindex="-1" id="menu-item-0">Bantuan</a>
                                            <form action="/logout" method="post">
                                                @csrf
                                                <button type="submit" class="w-full text-left text-stone-700 block px-4 py-2 text-sm hover:bg-stone-100 hover:underline">Keluar</button>
                                            </form>
                                        </li>
                                    </ul>
                                @else
            ...
            <footer class="py-20 w-full z-20 mx-auto align-center justify-center left-0 text-violet-800">
                <a href="/" class="flex items-center mx-auto py-2 justify-center align-center">
                    <svg class="" width="20" height="20" fill="currentColor" viewBox="0 0 512 512"><path d="M512 96c0 50.2-59.1 125.1-84.6 155c-3.8 4.4-9.4 6.1-14.5 5H320c-17.7 0-32 14.3-32 32s14.3 32 32 32h96c53 0 96 43 96 96s-43 96-96 96H139.6c8.7-9.9 19.3-22.6 30-36.8c6.3-8.4 12.8-17.6 19-27.2H416c17.7 0 32-14.3 32-32s-14.3-32-32-32H320c-53 0-96-43-96-96s43-96 96-96h39.8c-21-31.5-39.8-67.7-39.8-96c0-53 43-96 96-96s96 43 96 96zM117.1 489.1c-3.8 4.3-7.2 8.1-10.1 11.3l-1.8 2-.2-.2c-6 4.6-14.6 4-20-1.8C59.8 473 0 402.5 0 352c0-53 43-96 96-96s96 43 96 96c0 30-21.1 67-43.5 97.9c-10.7 14.7-21.7 28-30.8 38.5l-.6 .7zM128 352a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zM416 128a32 32 0 1 0 0-64 32 32 0 1 0 0 64z"/></svg>
                    <span class="clashdisplaymedium text-violet-800 px-2 text-xl font-extrabold whitespace-nowrap">Routely</span>
                </a>
                <span id="copyright" class="clashdisplaymedium copyright block text-sm text-center"></span>
            </footer>
        </main>
    </body>
</html>
