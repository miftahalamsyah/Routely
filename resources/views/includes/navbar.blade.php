<!-- Sidebar Toggle -->
<div class="sticky top-2 rounded-3xl mx-2 bg-stone-50 shadow-md inset-x-0 z-30 border-b px-4 sm:px-6 md:px-8 md:hidden lg:hidden">
    ...
    <button id="sidebar-toggle" class="text-stone-700 hover:text-stone-600 focus:outline-none focus:text-stone-700" aria-label="Toggle sidebar">
        ...
        <ol class="mx-3 flex items-center leading-none whitespace-nowrap" aria-label="Breadcrumb">
            <li class="text-sm font-semibold text-student truncate" aria-current="page">
                {{ $title }}
            </li>
        </ol>
        <!-- End Breadcrumb -->
