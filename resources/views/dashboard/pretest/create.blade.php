    ...
    <div class="bg-gray-50 rounded-xl mx-3">
        <div class="row">
            <div class="col-md-12 p-5">
                <h1 class="font-semibold text-4xl text-center my-8  ">Tambah Soal Pretest</h1>
                <div class="border-0 shadow-sm">
                    ...
                    <form action="{{ route('pretest.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea type="text" id="pertanyaan" name="pertanyaan" placeholder="Masukkan pertanyaannya" class="w-full px-4 py-2 border rounded-lg focus:ring-violet-400 focus:border-violet-400">{{ old('pertanyaan') }}
                            </textarea>
                            @error('pertanyaan')
                                <div class="text-red-500 mt-2 text-sm">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <textarea type="text" id="jawaban_b" name="jawaban_b" placeholder="Masukkan opsi_b nya" class="w-full px-4 py-2 border rounded-lg focus:ring-violet-400 focus:border-violet-400">{{ old('jawaban_b') }}
                            </textarea>
                            @error('jawaban_b')
                                <div class="text-red-500 mt-2 text-sm">{{ $message }}</div>
                            @enderror
