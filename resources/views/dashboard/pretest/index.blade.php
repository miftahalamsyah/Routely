...
<section class="row z-0 p-4 max-w-6xl align-center mx-auto min-h-screen">
    <div class="my-8 text-center">
        <h1 class="mb-6 text-3xl font-extrabold leading-none tracking-normal text-stone-300 md:tracking-tight">Daftar Soal Pretest</h1>
    </div>
                            ...
                            <table class="min-w-full divide-y divide-stone-600">
                                ...
                                <tbody class="divide-y divide-stone-600">
                                    @forelse ($soal_tes as $index => $soal)
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-center table-cell-3em">
                                                {{ $index + 1 }}
                                            </td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex space-x-2 justify-end">
                                                    <a href="{{ route('pretest.edit', $soal->id) }}" class="text-stone-300 hover:text-violet-500">
