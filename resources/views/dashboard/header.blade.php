<div class="top-0 fixed w-full z-20 left-0">
    <div class="bg-stone-800 bg-opacity-75 backdrop-blur-sm">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center">
                ...
                <span class="self-center px-2 text-lg font-extrabold whitespace-nowrap text-gray-50">Routely - Guru<lg/span>
            </a>
            <div class="flex md:order-2">
                ...
                <div class="navbarmobile hidden">
                    ...
                    <button id="hideBreadcrumbs" class="text-green-900 font-bold border-gray-350 border hover:bg-stone-700 font-bold rounded-2xl text-sm px-4 py-2 text-center mr-3 md:mr-0" style="display: none;">
