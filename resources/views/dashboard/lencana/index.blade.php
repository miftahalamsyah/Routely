...
<section class="row z-0 p-4 max-w-6xl align-center mx-auto min-h-screen">
    <div class="my-8 text-center">
        <h1 class="mb-6 text-3xl font-extrabold leading-none tracking-normal text-gray-50 md:tracking-tight">Daftar Lencana</h1>
    </div>
        ...
        <div class="row">
            <div class="col-md-12 p-5">
                <div class="border-0 shadow-sm">
                    <div class="">
                        <button class="bg-violet-400 my-2 p-2 rounded-xl hover:bg-violet-300"><a href="{{ route('lencana.create') }}" class="text-md font-semibold p-2">Tambah Lencana</a></button>
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse ($lencanas as $index=>$lencana)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                {{ $lencana->gambar_lencana }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex space-x-2 justify-end">
                                                    <a href="{{ route('lencana.edit', $lencana->id) }}" class="text-blue-600 hover:text-blue-900">
                                                    ...
                                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('lencana.destroy', $lencana->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
