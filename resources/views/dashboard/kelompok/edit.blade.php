    ...
    <div class="bg-gray-50 rounded-xl mx-3">
        <div class="row">
            <div class="col-md-12 p-5">
                <h1 class="font-semibold text-stone-800 text-4xl text-center my-8  ">Edit Kelompok</h1>
                <div class="border-0 shadow-sm">
                    ...
                    <form action="{{ route('kelompok.update', $kelompok->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="no_kelompok" name="no_kelompok" value="{{ $kelompok->no_kelompok }}" placeholder="Nomor Kelompok"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" name="name" value="{{ $kelompok->name }}" placeholder="Masukkan Nama Kelompok"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="5"
                                ...
                                class="w-full px-4 py-2 border rounded-lg focus:ring-violet-400 focus:border-violet-400 @error('description') border-red-500 @enderror">{{ $kelompok->description }}</textarea>
                            @error('description')
                                <div class="text-red-500 mt-2 text-sm">{{ $message }}</div>
                            @enderror
                            </input>
