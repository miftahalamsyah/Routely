...
<head>
    ...
    <title>Tambah User | Routely Admin</title>
</head>
    ...
    <div class="bg-gray-50 rounded-xl mx-3">
        <div class="row">
            <div class="col-md-12 p-5">
                <h1 class="font-semibold text-4xl text-center my-8  ">Tambah User</h1>
                <div class="border-0 shadow-sm">
                    ...
                    <form action="{{ route('siswa.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="email" name="email" value="{{ old('email') }}" placeholder="Masukkan E-Mail Lengkap"
