...
<section class="row p-4 z-0 max-w-6xl align-center mx-auto">
    ...
    <div class="flex justify-between m-3">
        <a href="/dashboard/kategori-tes/" class="flex text-stone-300">
        ...
        <button class="bg-violet-700 p-2 rounded-xl text-stone-300"><a href="{{ route('kategori-tes.exportPretest', $kategoriTes->id) }}" class="text-md font-semibold p-2">Ekspor ke Spreadsheets</a></button>
    </div>
