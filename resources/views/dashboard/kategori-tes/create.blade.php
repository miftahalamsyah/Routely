            ...
            <div class="col-md-12 p-5">
                ...
                <div class="border-0 shadow-sm">
                    ...
                    <form action="{{ route('kategori-tes.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <label for="status_tess" class="block text-md font-semibold text-gray-800">Apakah tersedia untuk siswa?</label>
                            <input type="checkbox" id="status_tess" name="status_tess" {{ old('status_tess') ? 'checked' : '' }}
                                class="form-checkbox h-5 w-5 text-violet-600">
                                <span class="ml-2 text-gray-700">Status Tes (Tersedia)</span>
                            </input>
                        </div>
