    ...
    <div class="bg-gray-50 rounded-xl mx-3">
        <div class="row">
            <div class="col-md-12 p-5">
                <h1 class="font-semibold text-4xl text-center my-8  ">Tambah nilai</h1>
                <div class="border-0 shadow-sm">
                    ...
                    <form action="{{ route('nilai.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="pretest" name="pretest" min="0" max="100" value="{{ old('pretest') }}" placeholder="0-100"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="posttest" name="posttest" min="0" max="100" value="{{ old('posttest') }}" placeholder="0-100"
