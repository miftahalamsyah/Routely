...
<section class="row z-0 p-4 max-w-6xl align-center mx-auto">
    ...
    <div class="bg-stone-800 border border-stone-600 rounded-xl mx-3 border border-stone-600">
        <div class="row">
    ...
    <div class="bg-stone-800 rounded-xl mx-3 border border-stone-600 mt-12 text-stone-300 p-5">
        <h2 class="font-semibold text-lg text-center">Siswa yang Belum Mengerjakan Posttest</h2>
                    ...
                    <tr>
                        <td colspan="2" class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="mx-auto bg-stone-800 text-stone-300 p-2 rounded-xl">
                                Semua siswa telah mengerjakan posttest.
                            </div>
                        </td>
                    </tr>
                @endforelse
