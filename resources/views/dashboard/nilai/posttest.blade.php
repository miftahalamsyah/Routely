...
<section class="row z-0 p-4 max-w-6xl align-center mx-auto">
    <h1 class="my-2 text-center text-3xl font-extrabold leading-none tracking-normal text-stone-50 md:tracking-tight">Nilai Posttest</h1>
    <div class="flex justify-between m-3">
        ...
        <button class="bg-student p-2 rounded-xl text-gray-50"><a href="{{ route('nilai.posttest.export') }}" class="text-md font-semibold p-2">Eksport ke Spreadsheets</a></button>
    </div>
