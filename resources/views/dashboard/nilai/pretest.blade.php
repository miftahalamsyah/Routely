...
<section class="row z-0 p-4 max-w-6xl align-center mx-auto">
    <h1 class="my-8 text-center text-3xl font-extrabold leading-none tracking-normal text-stone-50 md:tracking-tight">Nilai Pretest</h1>
    <div class="flex justify-between m-3">
        <a href="/dashboard/nilai" class="flex">
            ...
            <p class="ml-2 font-semibold text-md text-stone-50">Kembali</p>
        </a>
        <button class="bg-student p-2 rounded-xl text-stone-50"><a href="{{ route('nilai.pretest.export') }}" class="text-md font-semibold p-2">Ekspor ke Spreadsheets</a></button>
    </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 bg-stone-100 text-center text-xs font-medium text-stone-500 uppercase tracking-wider">
                                            Total Nilai
                                        </th>
                                        <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-stone-500 uppercase tracking-wider">
                                            Dekomposisi
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse ($nilaiPretest as $index=>$nilai)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap bg-stone-100 text-center">
                                                {{ $nilai->total }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                {{ $nilai->dekomposisi }}
