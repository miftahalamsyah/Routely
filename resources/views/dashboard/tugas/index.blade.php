                    ...
                    <div class="">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-stone-200">
                                <thead>
                                    <tr>
                                        <th scope="col" class="px-6 py-3 bg-stone-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                            No
                                        </th>
                                        <th scope="col" class="px-6 py-3 bg-stone-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                            Pertemuan Ke
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex space-x-2 justify-end"> <!-- Use justify-end to align content to the right -->
                                                    <a href="{{ route('tugas.show', $tugas->id) }}" class="text-stone-800 hover:text-student">
                                                    ...
                                                    <a href="{{ route('tugas.edit', $tugas->id) }}" class="text-stone-800 hover:text-student">
                                                    ...
                                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('tugas.destroy', $tugas->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="text-stone-800 hover:text-red-800">
