<!-- Sidebar Toggle -->
<div class="sticky top-0 bg-stone-900 inset-x-0 z-1 border-b border-stone-700 px-4 sm:px-6 md:px-8 lg:hidden">
...
<!-- Sidebar -->
<div id="logo-sidebar" class="-translate-x-full transition-all duration-300 transform fixed top-0 left-0 bottom-0 z-10 w-64 bg-stone-900 border-r border-stone-700 pt-7 pb-10 overflow-y-auto scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0">
    ...
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap">
        <ul class="space-y-1.5">
            ...
            <details class="group [&_summary::-webkit-details-marker]:hidden">
                <summary class="flex cursor-pointer items-center justify-between rounded-sm px-2.5 py-2 text-stone-100 hover:bg-stone-700 {{ in_array($title, ['Pertemuan', 'Tambah Pertemuan', 'Edit Pertemuan', 'Tugas', 'Tambah Tugas', 'Edit Tugas', 'Materi', 'Tambah Materi', 'Edit Materi', 'Refleksi', 'Hasil Pengerjaan Tugas', 'Apersepsi', 'Soal Kuis', 'Tambah Soal Kuis', 'Edit Soal Kuis', 'Impor Soal Kuis']) ? 'bg-violet-700 text-stone-100 hover:bg-violet-700' : '' }}">
            ...
            <details class="group [&_summary::-webkit-details-marker]:hidden">
                <summary class="flex cursor-pointer items-center justify-between rounded-sm px-2.5 py-2 text-stone-100 hover:bg-stone-700 {{ in_array($title, ['Kategori Tes', 'Tambah Kategori Tes', 'Edit Kategori Tes', 'PreTest', 'Tambah Soal Pretest', 'Tambah Soal Posttest', 'Tes Harian', 'PostTest', 'Edit Soal Pretest', 'Edit Soal Posttest', 'Import Soal Pretest', 'Import Soal Posttest']) ? 'bg-violet-700 text-stone-100 hover:bg-violet-700' : '' }}">
                    <div class="flex gap-x-3.5">
            ...
            <!--<li>
                <a class="rounded-sm flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-stone-100 hover:bg-stone-700 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300" href="javascript:;">
            ...
            <li>
                <a class="rounded-sm flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-stone-100 hover:bg-stone-700 {{ in_array($title, ['Siswa', 'Tambah Siswa', 'Edit Siswa']) ? 'bg-violet-700 text-stone-100 hover:bg-violet-700' : '' }}" href="/dashboard/siswa">
            ...
            <li>
                <a class="rounded-sm flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-stone-100 hover:bg-stone-700 {{ in_array($title, ['Kelompok', 'Tambah Kelompok', 'Edit Kelompok']) ? 'bg-violet-700 text-stone-100 hover:bg-violet-700' : '' }}" href="/dashboard/kelompok">
            ...
            <li>
                <a class="rounded-sm flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-stone-100 hover:bg-stone-700 {{ in_array($title, ['Nilai', 'Nilai Pretest', 'Nilai Posttest', 'Isi Nilai Tugas', 'Edit Nilai Tugas', 'Nilai Tugas', 'Nilai Kuis', 'Nilai Siswa', 'Nilai Kuis Siswa']) ? 'bg-violet-700 text-stone-100 hover:bg-violet-700' : '' }}"" href="/dashboard/nilai">
            ...
            <!--<li>
                <a class="rounded-sm flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-stone-100 hover:bg-stone-700 {{ in_array($title, ['Lencana', 'Tambah Lencana', 'Edit Lencana']) ? 'bg-violet-700 text-stone-100 hover:bg-violet-700' : '' }}" href="/dashboard/lencana">
            ...
            <form action="/logout" method="post">
                @csrf
                <button type="submit" class="flex w-full items-center gap-x-3.5 py-2 px-2.5 text-sm text-stone-100 rounded-sm hover:bg-stone-700">
