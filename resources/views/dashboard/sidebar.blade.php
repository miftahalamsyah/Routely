...
<div id="logo-sidebar" class="-translate-x-full transition-all duration-300 transform fixed top-0 left-0 bottom-0 z-10 w-64 bg-stone-800 border-r border-stone-700 pt-7 pb-10 overflow-y-auto scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0">
    ...
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap">
        <ul class="space-y-1.5">
            ...
            <li>
                <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-stone-50 rounded-md hover:bg-stone-700 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300" href="javascript:;">
            ...
            <li>
                <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-stone-50 hover:bg-stone-700 {{ $title === 'Siswa' ? 'bg-violet-700 text-stone-50 hover:bg-violet-700' : '' }}" href="/dashboard/siswa">
                    <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
