    ...
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap">
        <ul class="space-y-1.5">
            ...
            <details class="group [&_summary::-webkit-details-marker]:hidden">
                <summary class="flex cursor-pointer items-center justify-between rounded-lg px-2.5 py-2 text-stone-100 hover:bg-stone-700 {{ in_array($title, ['Pertemuan', 'Tugas', 'Materi', 'Refleksi']) ? 'bg-violet-700 text-stone-100 hover:bg-violet-700' : '' }}">
                ...
                <ul class="mt-2 space-y-1 px-4">
                    ...
                    <li>
                        <a href="/dashboard/tugas" class="block rounded-lg px-6 py-2 text-sm font-medium text-stone-100 hover:bg-stone-700 {{ $title === 'Tugas' ? 'bg-violet-700 text-stone-100 hover:bg-violet-700' : '' }}">
                        Tugas
                        </a>
                    </li>
                    <li>
            ...
            <li>
                <a class="rounded-xl flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-stone-100 hover:bg-stone-700 {{ in_array($title, ['Nilai', 'Nilai Pretest', 'Nilai Posttest']) ? 'bg-violet-700 text-stone-100 hover:bg-violet-700' : '' }}"" href="/dashboard/nilai">
