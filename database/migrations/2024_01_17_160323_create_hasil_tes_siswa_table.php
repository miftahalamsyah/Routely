...
return new class extends Migration
{
    ...
    {
        Schema::create('hasil_tes_siswas', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('kategori_tes_id')->constrained()->onDelete('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('hasil_tes_siswa');
    }
};
